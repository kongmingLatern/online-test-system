...
export function registGlobalComponent(component: DefineComponent<any, any, any, any>, options?: Record<string, any>): VueWrapper<any> {
...
export function configComponent(component: DefineComponent<any, any, any, any>, testName: string, options?: Record<string, any>,): any {
  return mount(component, {
    global: {
      components: globalComponents,
      // 如果是在文件中注册的组件,需要使用 stubs
