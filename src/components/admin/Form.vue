...
onMounted(async () => {
  ...
  // 继续请求
  const [result, __] = await baseStore.getBaseList(subjectId.value);
  ...
  console.log(baseTitle[firstSubjectName.value][0].baseTitle);
});
...
watchEffect(() => {
  ...
  formState.secondBaseTitle = baseTitle[formState.firstSubjectName]
